  ...
  return {
    ...
    boardWon: function boardWon(bo, boPosition) {
      ...
      if (bo.topLeft && bo.topLeft === bo.topCenter && bo.topLeft === bo.topRight) {
        ...
        bo.middleLeft &&
        bo.middleLeft === bo.middleCenter &&
        bo.middleLeft === bo.middleRight
      ) {
        ...
        bo.bottomLeft &&
        bo.bottomLeft === bo.bottomCenter &&
        bo.bottomLeft === bo.bottomRight
      ) {
        ...
        bo.topCenter &&
        bo.topCenter === bo.middleCenter &&
        bo.topCenter === bo.bottomCenter
      ) {
    ...
    gameOver: function gameOver(boardState) {
      if (
        boardState.topLeft.winner &&
        boardState.topLeft.winner === boardState.topCenter.winner &&
        boardState.topLeft.winner === boardState.topRight.winner
      ) {
        this.winner = boardState.topLeft.winner;
      } else if (
        boardState.middleLeft.winner &&
        boardState.middleLeft.winner === boardState.middleCenter.winner &&
        boardState.middleLeft.winner === boardState.middleRight.winner
      ) {
        this.winner = boardState.middleLeft.winner;
      } else if (
        boardState.bottomLeft.winner &&
        boardState.bottomLeft === boardState.bottomCenter.winner &&
        boardState.bottomLeft === boardState.bottomRight.winner
      ) {
        this.winner = boardState.bottomLeft.winner;
      } else if (
        boardState.topLeft.winner &&
        boardState.topLeft.winner === boardState.middleLeft.winner &&
        boardState.topLeft.winner === boardState.bottomLeft.winner
      ) {
        this.winner = boardState.topLeft.winner;
      } else if (
        boardState.topCenter.winner &&
        boardState.topCenter.winner === boardState.middleCenter.winner &&
        boardState.topCenter.winner === boardState.bottomCenter.winner
      ) {
        this.winner = boardState.topCenter.winner;
      } else if (
        boardState.topRight.winner &&
        boardState.topRight.winner === boardState.middleRight.winner &&
        boardState.topRight.winner === boardState.bottomRight.winner
      ) {
        this.winner = boardState.topRight.winner;
      } else if (
        boardState.topLeft.winner &&
        boardState.topLeft.winner === boardState.middleCenter.winner &&
        boardState.topLeft.winner === boardState.bottomRight.winner
      ) {
        this.winner = boardState.topLeft.winner;
      } else if (
        boardState.topRight.winner &&
        boardState.topRight.winner === boardState.middleCenter.winner &&
        boardState.topRight.winner === boardState.bottomLeft.winner
      ) {
        this.winner = boardState.topRight.winner;
